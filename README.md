...
This is a Symfony 2.0 Sass, Compass, and Assetic project from the first Symfony Stammtisch Berlin.

    - see app/config.yml for filter chain
    - see src/Acme/DemoBundle/Ressources/views/layout.html.twig for how to embed the compiled files ino the project
    - The vendors are excluded

requirements please see:  http://alexandre-salome.fr/blog/Sass-Compass-Assetic-In-Ten-Minutes
